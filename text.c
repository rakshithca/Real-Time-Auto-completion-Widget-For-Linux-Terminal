...
// ACwidget - check if space is pressed in terminal
if(c!=' ')
{
	// Call the function to display all matches in complete.c
	rl_complete_internal('~'); 
}
else
{
	// Call this custom function in complete.c
...
rl_complete_internal('~'); // ACwidget -  added '~' case
